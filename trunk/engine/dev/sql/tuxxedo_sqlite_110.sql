...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>', '1', '0', '2');
INSERT INTO 'templates' ('id', 'title', 'source', 'compiledsource', 'defaultsource', 'styleid', 'changed', 'revision') VALUES ('2', 'footer', '	</body>
</html>', '	</body>
</html>', '	</body>
</html>', '1', '0', '2');
...
{$footer}', '1', '0', '2');
INSERT INTO 'templates' ('id', 'title', 'source', 'compiledsource', 'defaultsource', 'styleid', 'changed', 'revision') VALUES ('6', 'error_listbit', '<li>{$error}</li>', '<li>{$error}</li>', '<li>{$error}</li>', '1', '0', '1');
# --------------------------------------------------------
